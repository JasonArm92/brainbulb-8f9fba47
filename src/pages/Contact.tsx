...
export const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4 pb-24 tech-grid relative overflow-hidden">
      ...
      <div className="fixed top-1/3 left-0 w-[300px] h-[300px] bg-primary/10 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-1/3 right-0 w-[250px] h-[250px] bg-primary-glow/10 rounded-full blur-3xl pointer-events-none" />
