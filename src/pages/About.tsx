...
export const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4 pb-24 tech-grid relative overflow-hidden">
      ...
      {/* Ambient effects */}
      <div className="fixed top-1/4 right-0 w-[500px] h-[500px] bg-primary/15 rounded-full blur-[150px] pointer-events-none animate-float-rotate" />
      <div className="fixed bottom-1/4 left-0 w-[400px] h-[400px] bg-primary-glow/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="fixed top-0 left-1/2 w-[300px] h-[300px] bg-accent-green/10 rounded-full blur-[100px] pointer-events-none" />
